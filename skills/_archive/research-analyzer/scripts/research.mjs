...
Examples:
  ...
  research.mjs "machine learning" --scholar --abstract
  research.mjs "Rust vs Go" --compare --output report.md
`);
  process.exit(0);
}
...
const options = {
  ...
  scholar: args.includes('--scholar'),
  abstract: args.includes('--abstract'),
...
console.log(`Mode: ${options.scholar ? '学术' : options.compare ? '对比' : options.tech ? '技术' : '标准'}\n`);
