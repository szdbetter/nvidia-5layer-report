...
description: "Build reusable advisor-style digital twins for KOLs, founders, operators, investors, or domain experts from public writings, interviews, threads, transcripts, or notes. Use when the user wants to: (1) convert source material into clean Markdown corpus, (2) define a knowledge cutoff date and source boundary, (3) extract an advisor card merging persona, capability, decision rules, suitable scenarios, and non-goals, (4) generate a reusable avatar/system prompt that answers in the subject’s thinking model and voice, or (5) standardize the process into a repeatable skill/SOP."
---
